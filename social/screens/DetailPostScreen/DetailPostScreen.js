...
class DetailScreen extends Component {
  ...
  componentDidMount() {
    ...
    this.unsubscribeSinglePost = postAPIManager.subscribeToSinglePost(
      this.item.id,
      this.onFeedItemUpdate,
    );
    this.unsubscribeComments = commentAPIManager.subscribeComments(
      this.item.id,
  ...
  onReaction = async (reaction, item) => {
    await commentAPIManager.handleReaction(
      reaction,
      this.props.user,
      item,
      true,
