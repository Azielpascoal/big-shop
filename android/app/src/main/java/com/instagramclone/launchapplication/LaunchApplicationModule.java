package io.instamobile.instagram.rn.android.launchapplication;
...
public class LaunchApplicationModule extends ReactContextBaseJavaModule {
  ...
  //  Intent dialogIntent = new Intent(getReactApplicationContext(), MainActivity.class);
    Intent dialogIntent = getReactApplicationContext().getPackageManager().getLaunchIntentForPackage("io.instamobile.socialnetwork.rn.android");
